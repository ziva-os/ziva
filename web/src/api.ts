...
export async function updateSession(sid: string, updates: { name?: string; model_name?: string; provider_name?: string; thinking_mode?: string; workspace?: string; approval_policy?: string }): Promise<void> {
